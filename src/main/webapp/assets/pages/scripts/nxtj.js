...
function getRandomData(){
    ...
    ChartsAmcharts.init(myFillData,"chart_1",["单位面积能耗"]);
    ChartsAmcharts.init(myFillData,"chart_2",["空调主机COP"]);
    ChartsAmcharts.init(myFillData,"chart_3",["空调系统能效"]);
}

jQuery(document).ready(function() {
    $('.mydate').datepicker({orientation:'bottom auto'});
    getRandomData();
