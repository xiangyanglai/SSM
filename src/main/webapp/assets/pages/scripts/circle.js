jQuery(document).ready(function() {
	var tbfx_bar = echarts.init(document.getElementById("tbfx_bar"));
	var hbfx_bar = echarts.init(document.getElementById("hbfx_bar"));
	...
	tbfx_bar.setOption(option);
	hbfx_bar.setOption(option);
